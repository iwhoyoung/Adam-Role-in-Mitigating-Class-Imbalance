...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.category_loss and (not args.multiprocessing_distributed or (args.multiprocessing_distributed and args.rank % ngpus_per_node == 0)):
        ...
        train_csv_path = os.path.join(args.output_dir, 'train_category_loss_'+str(args.lr)+'_'+str(args.batch_size)+'_'+str(args.optimizer)+'_'+str(args.arch)+'.csv')
        val_csv_path = os.path.join(args.output_dir, 'val_category_loss_'+str(args.lr)+'_'+str(args.batch_size)+'_'+str(args.optimizer)+'_'+str(args.arch)+'.csv')
