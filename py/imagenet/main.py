...
def main_worker(gpu, ngpus_per_node, args):
    ...
    try:
        ...
        train_loader = create_loader(train_dataset, (3, 224, 224), 4)
    except:
        train_loader = create_loader(train_dataset, (3, 224, 224), 4, use_prefetcher=False)

    try:
        # only works if gpu present on machine
        val_loader = create_loader(val_dataset, (3, 224, 224), 4)
    except:
        val_loader = create_loader(val_dataset, (3, 224, 224), 4, use_prefetcher=False)
