...
from resnet_cust import Bottleneck, CAMResNet, BasicBlock, ResNetOrigin, BasicBlockwores
...
model_name = 'res18new'# res18vconv13x3 vgg16bn vits
opt_name = 'adacertainty'#sgdwnormandsumadam sgdwredistribution8andnorm adacertaintywoadd
...
if __name__ == '__main__':
    ...
    model = ResNetOrigin(BasicBlock, [2, 2, 2, 2],num_classes=100) #3 4 6 3
    # model = ResNetOrigin(Bottleneck, [3, 4, 6, 3],num_classes=100) #3 4 6 3
    ...
    # model = swin_t_32(num_classes=100)
